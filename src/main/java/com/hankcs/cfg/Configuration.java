...
public class Configuration {
    ...
    private boolean enableDynamicCustomDictionary;
    ...
    public Configuration(Environment env, Settings settings) {
        ...
        this.enableDynamicCustomDictionary = settings.get("enable_dynamic_custom_dictionary", "false").equals("true");
    ...
    public boolean isEnableDynamicCustomDictionary() {
        return enableDynamicCustomDictionary;
    }
